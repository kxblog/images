...
get_header(); ?>
	...
	<section id="picture" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<article id="post-<?php the_ID(); ?>" <?php if (zm_get_option('cat_five') ) { ?><?php post_class('grid-five picture wow fadeInUp'); ?><?php } else { ?><?php post_class('picture wow fadeInUp'); ?><?php } ?>>
